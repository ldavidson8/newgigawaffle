    ...
    <div className="grid grid-cols-1 gap-8 place-items-center px-8 md:px-60 py-32">
      <div>
        ...
        <p>
          ...
          recorded by Gigawaffle and how we use it.
        </p>
        <p>
        ...
        <p>
          ...
          shared and/or collect in Gigawaffle. This policy is not applicable to
      ...
      <div>
        ...
        <p>
          ...
          advertisements and links that appear on Gigawaffle, which are sent
        ...
        <p>
          Note that Gigawaffle has no access to or control over these cookies
      ...
      <div>
        ...
        <p>
          Gigawaffle does not knowingly collect any Personal Identifiable
